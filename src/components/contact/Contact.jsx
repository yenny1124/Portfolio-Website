...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_w8f11gs', 'template_6ztj1hf', formRef.current, '_J5D8bJg8Au9tRdb2')
            .then((result) => {
                setSuccess(true)
            }, (error) => {
                setError(true)
        ...
        <motion.div className="contact" variants={variants} initial="initial" whileInView="animate">
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="item">
                    <h2>Mail</h2>
                    <span>yeeunchoi94@gmail.com</span>
                </motion.div>
                <motion.div className="item">
                    <h2>LinkedIn</h2>
                    <a href="https://www.linkedin.com/in/jamieyeeunchoi/">
                        <span>https://www.linkedin.com/in/jamieyeeunchoi/</span>
                    </a>
                </motion.div>
                <motion.div className="item">
                    <h2>GitHub</h2>
                    <a href="https://github.com/yenny1124">
                        <span>https://github.com/yenny1124</span>
                    </a>
                </motion.div>
            </motion.div>
